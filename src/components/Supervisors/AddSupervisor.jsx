...
//         "https://bulding-constraction-employee-management.onrender.com/api/supervisors/check",
...
//       return toast.error("Please enter a valid email (e.g., prabas@gmail.com)");
//     }
...
//           value.forEach((file) => {
//             payload.append("supervisorIdProof", file);
//           });
//         } else {
...
//           ← Back
//         </button>
//         <h3 className="text-primary fw-bold mb-0 text-center">
//           ➕ Add New Supervisor
//         </h3>
//         <div></div>
//       </div>
...
//           <h5 className="fw-semibold text-primary mb-3">👷 Supervisor Details</h5>
//           <div className="row g-3">
//             {[
//               { label: "Name", name: "name", type: "text" },
//               { label: "Email", name: "email", type: "email", autoComplete: "off" },
...
//         {/* Upload Photo */}
//         <div className="bg-light shadow-sm rounded-4 p-4 mb-4">
//           <h5 className="fw-semibold text-primary mb-3">📸 Upload Photo</h5>
//           <input
//             type="file"
//             name="photo"
//             className="form-control"
...
//         {/* Upload ID Proofs */}
//         <div className="bg-light shadow-sm rounded-4 p-4 mb-4">
//           <h5 className="fw-semibold text-primary mb-3">🆔 Upload ID Proofs</h5>
//           <input
//             type="file"
              ...
              <form onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <ActionButtons>
                  ...
                  <PrimaryButton type="submit" disabled={loading}>
                    <FaSave /> {loading ? "Adding..." : "Add Supervisor"}
                  </PrimaryButton>
                </ActionButtons>
              </form>
            </CardBody>
