...
//         const filteredBySupervisor = res.data.data.filter(
//           (item) => item.supervisorId?._id === user?._id
//         );
//         setAllPayments(filteredBySupervisor);
//         if (filteredBySupervisor.length === 0)
...
//     XLSX.writeFile(wb, "contractor-payment-report.xlsx");
...
//     doc.setFontSize(18);
//     doc.text("💰 Contractor Payment Report", 40, 40);
...
//     doc.save("contractor-payment-report.pdf");
...
//       <div className="mb-4">
//         <h3 className="fw-bold">💰 Contractor Payment Report</h3>
//       </div>
...
//           </Col>
//           <Col xs={12} sm={6} md={3}>
//             <Form.Label>Search by Contractor Name</Form.Label>
//             <Form.Control
//               type="text"
...
const CPaymentReport = () => {
  ...
  return (
    <Container>
      <Header>
        <h2>Contractor Payment Reports</h2>
        <p>View and export contractor payment records</p>
      </Header>
