...
//         const recordDate = dayjs(item[dateField], [
//           "DD/MM/YYYY",
//           "YYYY-MM-DD",
//         ]);
...
//       if (Array.isArray(report.rangeRecords)) {
//         report.rangeRecords.forEach((rec) => {
...
//     setFilteredAttendance(filterByDate(flattenedAttendance, "date"));
//     setFilteredSalary(filterByDate(salaryReports, "date"));
...
//       <h3 className="fw-bold mb-4">📊 My Reports</h3>
...
//                   variant="success"
//                   onClick={() =>
//                     exportExcel(filteredSalary, "salary-reports")
//                   }
//                 >
//                   <FaFileExcel className="me-2" /> Export Excel
//                 </Button>
