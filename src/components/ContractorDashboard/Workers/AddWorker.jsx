...
// // ✅ All worker roles with same sub roles
...
//         `https://bulding-constraction-employee-management.onrender.com/api/workers/check-email/${email}`,
//         {
...
//     if (emailExists) return toast.error("This email is already registered");
...
//       payload.append("joiningDate", formatDate(formData.joiningDate));
...
//       } else {
//         toast.error("❌ Failed to add worker: " + (res.data.message || ""));
//       }
//     } catch (err) {
              ...
              <form onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <ActionButtons>
                  ...
                  <PrimaryButton type="submit" disabled={loading}>
                    <FaSave /> {loading ? "Adding..." : "Add Worker"}
                  </PrimaryButton>
                </ActionButtons>
              </form>
            </CardBody>
