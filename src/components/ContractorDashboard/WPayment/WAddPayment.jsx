...
//   // ✅ Fetch workers matching contractor's roleType
//   useEffect(() => {
...
//           }
//         } else {
//           toast.error("Worker list is empty or invalid.");
//         }
//       } catch (err) {
...
//     if (!workerId || !startDate || !endDate || paidAmount === "") {
//       return toast.error("Please fill all required fields.");
//     }

//     const selectedWorker = workers.find(
//       (w) => String(w._id) === String(workerId)
//     );
...
//         "https://bulding-constraction-employee-management.onrender.com/api/workers/salary",
//         payload,
//         {
//           headers: {
      ...
      <div className="row justify-content-center">
        <div className="col-12 col-lg-10">
          <Card>
            <CardHeader>
              <h2>
                <FaMoneyCheckAlt /> Add New Worker Payment
              </h2>
            </CardHeader>
            <CardBody>
              {loadingWorkers ? (
