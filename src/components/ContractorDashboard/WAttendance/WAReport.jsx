...
//           // ✅ Apply contractor role + user filter
//           if (
//             item.contractorUserId === user._id &&
//             item.contractorRole &&
//             item.contractorRole === user.roleType
//           ) {
//             const workerName =
//               item.name ||
//               item.workerName ||
...
//               if (raw?.status && raw?.date) {
//                 const parsedDate = dayjs(raw.date, [
//                   "YYYY-MM-DD",
//                   "DD/MM/YYYY",
//                   "MM/DD/YYYY",
//                   "ddd MMM DD YYYY",
...
//         } else {
//           setReports([]);
//           toast.warning("⚠️ No attendance records match your filters.");
//         }
//       } else {
//         setReports([]);
//         toast.warning("⚠️ No records found from server.");
//       }
//     } catch (err) {
...
const WAReports = () => {
  ...
  return (
    <Container>
      <Header>
        <h2>Worker Attendance Reports</h2>
        <p>View and export worker attendance records</p>
      </Header>
