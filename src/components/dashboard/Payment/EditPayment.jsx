...
//       const selected = supervisors.find((sup) => String(sup._id) === value);
...
//     try {
//       const [supervisorsRes, paymentsRes] = await Promise.all([
//         axios.get(
...
//           const selected = supervisorsList.find(
//             (sup) => String(sup._id) === String(data.supervisorId)
//           );
...
//       (sup) => String(sup._id).trim() === String(formData.supervisorId).trim()
//     );
...
//       perDaySalary: selectedSupervisor.perDaySalary || 0,
//       overtimeSalary: parseFloat(formData.overtimeSalary) || 0,
//       halfSalary: parseFloat(formData.halfSalary) || 0,
...
//           <FaEdit className="me-2" /> Update Payment
//         </Card.Header>
...
//                 <Col xs={12} md={4}>
//                   <Form.Group>
//                     <Form.Label className="fw-semibold">Overtime Salary</Form.Label>
//                     <Form.Control
//                       type="number"
//                       name="overtimeSalary"
...
//                 <Col xs={12} md={4}>
//                   <Form.Group>
//                     <Form.Label className="fw-semibold">Half Salary</Form.Label>
//                     <Form.Control
//                       type="number"
//                       name="halfSalary"
...
const EditPayment = () => {
      ...
      if (supervisorsRes.data.success) {
        ...
        if (paymentsRes.data.success) {
          ...
          setFormData({
            ...
            halfSalary: data.halfSalary || 0,
            allowances: data.allowances || 0,
            deductions: data.deductions || 0,
            advanceSalary: data.advanceSalary || 0,
  ...
  const handleSubmit = async (e) => {
    ...
    const selectedSupervisor = supervisors.find(
      (sup) => String(sup._id) === String(formData.supervisorId)
    );

    if (!selectedSupervisor) {
      return toast.error("Please select a valid supervisor.");
    }
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <FormGrid>
                    ...
                    <div>
                      ...
                      <FormGroup>
                        <label>
                          <FaMoneyBillWave /> Overtime Salary
                        </label>
                        <input
                          type="number"
                          className="form-control"
